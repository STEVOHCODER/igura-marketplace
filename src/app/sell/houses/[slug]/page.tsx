            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="text-right shrink-0">
                  <div className="text-3xl font-extrabold text-violet-600">{formatPrice(property.price)}</div>
                  <div className="text-sm text-slate-500">{t("detail.salePrice")}</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 mt-5 pt-5 border-t border-slate-100 text-sm text-slate-600">
                {(property.bedrooms != null || property.bathrooms != null) && (
                  <div className="flex items-center gap-4">
                    ...
                    {property.bathrooms != null && (
                      <span className="flex items-center gap-1.5">
                        <div className="h-8 w-8 rounded-lg bg-violet-50 flex items-center justify-center">
                          <Bath className="h-4 w-4 text-violet-600" />
                        </div>
                ...
                {property.areaValue != null && (
                  <span className="flex items-center gap-1.5">
                    <div className="h-8 w-8 rounded-lg bg-violet-50 flex items-center justify-center">
                      <Maximize className="h-4 w-4 text-violet-600" />
                    </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {property.keywords.map((kw) => (
                    <span key={kw.id} className="px-3 py-1.5 rounded-full bg-violet-50 text-violet-700 text-sm font-medium border border-violet-100">
                      {kw.keyword}
                    </span>
                  ))}
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 sticky top-24 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-5">
                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center shadow-sm shadow-violet-200">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">{t("detail.seller")}</div>
                </div>
              </div>
              {property.contactPhone && (
                <a
                  href={`tel:${property.contactPhone}`}
                  className="flex items-center justify-center gap-2 w-full bg-violet-600 text-white py-3.5 rounded-xl font-semibold hover:bg-violet-500 transition-all shadow-lg shadow-violet-600/20 hover:shadow-violet-500/30"
                >
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-slate-50">
                  ...
                  <dd className="font-bold text-violet-600">{formatPrice(property.price)}</dd>
                </div>
                <div className="flex justify-between py-2 border-b border-slate-50">
