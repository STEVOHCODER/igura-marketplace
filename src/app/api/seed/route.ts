...
export async function POST() {
  try {
    ...
    const plotPropsData = [
      { ownerId: agent.id, marketplaceId: plot.id, propertyTypeId: plotTypes[0].id, title: "Prime Residential Plot in Kimironko", slug: "prime-residential-plot-kimironko", description: "1000 sqm residential plot in developing area.", price: 15000000, areaValue: 1000, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Kimironko", latitude: -1.9393, longitude: 29.9606, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 456, contactRevealed: false },
      { ownerId: agent.id, marketplaceId: plot.id, propertyTypeId: plotTypes[1].id, title: "Commercial Plot on KN5 Road", slug: "commercial-plot-kn5-road", description: "Strategic commercial plot on main road.", price: 50000000, areaValue: 2000, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Remera", latitude: -1.9546, longitude: 29.9246, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 389, contactRevealed: false },
      { ownerId: client.id, marketplaceId: plot.id, propertyTypeId: plotTypes[0].id, title: "Residential Plot in Gitega", slug: "residential-plot-gitega", description: "500 sqm plot in quiet residential area.", price: 8000000, areaValue: 500, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Nyarugenge", locationCell: "Gitega", latitude: -1.9446, longitude: 29.9146, contactPhone: "+250788222222", contactName: "Marie Uwimana", status: "ACTIVE", viewCount: 123, contactRevealed: false },
      { ownerId: agent.id, marketplaceId: plot.id, propertyTypeId: plotTypes[2].id, title: "Agricultural Land in Bugesera", slug: "agricultural-land-bugesera", description: "5 hectares of fertile agricultural land.", price: 25000000, areaValue: 50000, areaUnit: "SQM", locationDistrict: "Bugesera", latitude: -2.2333, longitude: 29.9167, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 87, contactRevealed: false },
    ];
    ...
    const houseSellingPropsData = [
      { ownerId: agent.id, marketplaceId: houseSelling.id, propertyTypeId: houseSellingTypes[0].id, title: "Luxury 5-Bedroom Villa in Nyarutarama", slug: "luxury-5bedroom-villa-nyarutarama", description: "Exquisite luxury villa with modern amenities, private pool, and stunning views of Kigali hills.", price: 250000000, bedrooms: 5, bathrooms: 4, areaValue: 500, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Nyarutarama", latitude: -1.9350, longitude: 29.9500, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 567, contactRevealed: false },
      { ownerId: agent.id, marketplaceId: houseSelling.id, propertyTypeId: houseSellingTypes[1].id, title: "Modern 3-Bedroom Apartment in Kimihurura", slug: "modern-3bedroom-apartment-kimihurura", description: "Sleek modern apartment in diplomatic zone with smart home features.", price: 120000000, bedrooms: 3, bathrooms: 3, areaValue: 200, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Kimihurura", latitude: -1.9480, longitude: 29.9350, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 423, contactRevealed: false },
      { ownerId: client.id, marketplaceId: houseSelling.id, propertyTypeId: houseSellingTypes[2].id, title: "Elegant Townhouse in Kagugu", slug: "elegant-townhouse-kagugu", description: "Beautiful 4-bedroom townhouse with compound and servant quarters.", price: 85000000, bedrooms: 4, bathrooms: 3, areaValue: 350, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Kagugu", latitude: -1.9420, longitude: 29.9550, contactPhone: "+250788222222", contactName: "Marie Uwimana", status: "ACTIVE", viewCount: 312, contactRevealed: false },
      { ownerId: agent.id, marketplaceId: houseSelling.id, propertyTypeId: houseSellingTypes[3].id, title: "Premium Duplex in Kibagabaga", slug: "premium-duplex-kibagabaga", description: "Stunning duplex with panoramic city views and premium finishes.", price: 150000000, bedrooms: 4, bathrooms: 3, areaValue: 380, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Kibagabaga", latitude: -1.9380, longitude: 29.9620, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 289, contactRevealed: false },
      { ownerId: agent.id, marketplaceId: houseSelling.id, propertyTypeId: houseSellingTypes[4].id, title: "Family Bungalow in Kabuga", slug: "family-bungalow-kabuga", description: "Spacious single-story home with large compound, perfect for families.", price: 65000000, bedrooms: 4, bathrooms: 2, areaValue: 300, areaUnit: "SQM", locationDistrict: "Kigali City", locationSector: "Gasabo", locationCell: "Kabuga", latitude: -1.9460, longitude: 29.9580, contactPhone: "+250788111111", contactName: "Jean Hakizimana", status: "ACTIVE", viewCount: 198, contactRevealed: false },
    ];
